<div>
    <form wire:submit.prevent="saveLink">
        <div class="mb-4">
            ...
            <x-text-input wire:model.lazy="url" id="url" class="block my-2 w-full" type="text" placeholder="https://google.ca" required autofocus />
            @error('url') <span class="text-red-500">{{ $message }}</span> @enderror
        </div>

        <div class="mb-4">
            <label for="slug">Slug</label>
            <x-text-input wire:model.lazy="slug" id="slug" class="block my-2 w-full" type="text" placeholder="my-new-link" />
